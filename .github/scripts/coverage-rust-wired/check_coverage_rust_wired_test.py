"""Colocated unit tests for check_coverage_rust_wired.
...
import check_coverage_rust_wired as m  # noqa: E402

WIRED = "language: ${{ fromJSON(needs.detect.outputs.coverage_languages) }}\n"
...
def test_unwired_workflow_reports_the_missing_matrix():
    ...
    assert "coverage_languages" in msg
    assert "#171" in msg
