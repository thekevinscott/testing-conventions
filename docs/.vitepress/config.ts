        ...
        },
        {
          ...
          items: [
            ...
            { text: 'Glossary', link: '/reference/glossary' },
            {
              ...
              items: [
                { text: 'Static checks', link: '/reference/checks/static-checks' },
                { text: 'colocated-test', link: '/reference/checks/colocated-test' },
                { text: 'one-function-per-file', link: '/reference/checks/one-function-per-file' },
