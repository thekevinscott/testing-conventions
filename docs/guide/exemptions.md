...
A blocking gate needs an escape hatch for the files that genuinely shouldn't be tested: a
launcher shim, a pure re-export barrel, generated code. Otherwise the checker forces pointless
tests or fights your conventions, and someone disables it.
