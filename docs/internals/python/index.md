...
- [isolation.md](isolation.md) — **design.** The isolation & external-deps boundary (#42) made deterministic for Python: first-party via `pyproject.toml`, the `no-first-party-patch` integration lint, and the deferred unit direction.
