...
- [isolation.md](isolation.md) — **design.** The isolation & external-deps boundary (#44) made deterministic for Rust: the `syn` heuristic vs `dylint`, effectful-`std` policy, and red→green slices.
