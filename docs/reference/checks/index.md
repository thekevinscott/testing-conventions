...
| [`Workflow lint`](./workflow-lint) | `workflow-lint` | always — scans the calling repository's `.github` |
...
| [`workflow-lint`](./workflow-lint) | Workflow lint | Does every CI `run:` body read as **wiring** rather than a program? |
