...
| [`unit lint`](../explanation/isolation) | always | Python, TypeScript, Rust. Runs as a step of the `Static checks (<language>)` job. Scans `source`, leaving `<package root>/tests/` to the suite tiers. |
