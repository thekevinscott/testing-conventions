"""Colocated unit tests for the below-floor check (isolation — no CliRunner, no subprocess mocks).
...
"""
from checks.below_floor.cli import CHECKS, checks_for, cli, failure_reason
