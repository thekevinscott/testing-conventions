...
`.github/workflows/testing-conventions-selftest.yml` drives the published `unit lint --language rust` command over an un-isolated crate and asserts the non-zero exit that fails a consumer's build (#302 #309).
