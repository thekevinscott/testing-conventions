"""Colocated unit tests for the packaging-red check (isolation — no CliRunner, no subprocess mocks).
...
"""
from checks.packaging_red.cli import CHECKS, checks_for, cli, failure_reason
