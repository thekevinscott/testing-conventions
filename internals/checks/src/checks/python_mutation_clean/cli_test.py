"""Colocated unit tests for the python-mutation-clean check (isolation — no CliRunner, no subprocess mocks).
...
"""
from checks.python_mutation_clean.cli import CHECKS, checks_for, cli, failure_reason
