...
def check_move_gated_on_verification(text: Optional[str]) -> Optional[str]:
    ...
    if text is None:
        return (
            ...
            "nothing to gate on verification"
        )
    missing = []
    ...
    if missing:
        return (
            ...
            "rejects would still move @v0 and turn main/consumers red"
        )
    ...
    if not move_jobs:
        return (
            ...
            "stay the gated helper, not inline logic"
        )
