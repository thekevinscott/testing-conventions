"""End-to-end tests for the e2e-verify-wired command: real files, click's CliRunner.
...
from checks.e2e_verify_wired.cli import cli

REPO_ROOT = Path(__file__).resolve().parents[4]
WIRED = "inputs:\n  run_e2e:\n    default: false\nrun: npx -y testing-conventions e2e verify\n"
UNWIRED = "inputs:\n  run_e2e:\n    default: false\nrun: unit coverage\n"
...
def test_passes_on_a_wired_fixture(tmp_path):
    ...
    assert "offers opt-in e2e verify" in result.output
