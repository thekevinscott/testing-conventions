"""End-to-end tests for the integration-lint-new-arms-trip check: the real entry point, click's CliRunner, no mocks.
...
from checks.integration_lint_new_arms_trip.cli import cli
