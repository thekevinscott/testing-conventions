"""End-to-end tests for the mutation-package-root-wired command: real files, click's CliRunner.
...
from checks.mutation_package_root_wired.cli import cli
...
def test_passes_on_a_wired_fixture(tmp_path):
    ...
    assert "installs and builds from the derived package root" in result.output
