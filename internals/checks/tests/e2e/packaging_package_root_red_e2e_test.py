"""End-to-end tests for the packaging-package-root-red check: the real entry point, click's CliRunner, no mocks.
...
from checks.packaging_package_root_red.cli import cli
