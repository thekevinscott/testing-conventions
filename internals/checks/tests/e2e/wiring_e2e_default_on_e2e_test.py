"""End-to-end tests for the wiring-e2e-default-on command: real files, click's CliRunner.
...
from checks.wiring_e2e_default_on.cli import cli
...
def test_passes_on_a_wired_fixture(tmp_path):
    ...
    assert "e2e verify is default-on" in result.output
