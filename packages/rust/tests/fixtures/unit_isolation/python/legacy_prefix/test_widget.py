# Red fixture: a *legacy* `test_*.py` importing an un-mocked first-party
# collaborator (`unmocked-collaborator`). In the greenfield layout a unit test is `*_test.py` and a
